...
public class DctmQueryLookupStrategy implements QueryLookupStrategy {
	...
	public RepositoryQuery resolveQuery(Method method, RepositoryMetadata metadata, ProjectionFactory factory,
		...
		DctmQueryMethod queryMethod = new DctmQueryMethod(method, metadata, factory);
		...
		return method.getAnnotation(Query.class) == null
				? new PartTreeDctmQuery(applicationContext.getBean(MappingHandler.class), dctmOperations, queryMethod)
